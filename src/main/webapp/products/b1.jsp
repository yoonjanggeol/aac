			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title">헤비 오버핏 니트 </h5>
							<h5 class="card-title pt-3 pb-3 border-top" id="price">41,500원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">FREE</span>
							</p>
							<p class="card-text pb-3">헤비한 중량으로 따듯하게 착용 가능합니다 나일론을 유연제 처리하여 부드러운 착용감이 특징입니다.</p>
