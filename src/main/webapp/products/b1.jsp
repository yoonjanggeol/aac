				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">헤비 오버핏 니트</h5>
							
							<!-- 제품 가격 -->
							<hr/>
							PRICE
							<h5 class="card-title pt-3 pb-3 border-top" id="itemPrice">41500</h5>
							
							<!-- 제품 종류 -->
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark" id="itemType">상의</span>
								<span class="badge bg-dark">KNIT WEAR</span>
							</p>
							
							<p class="card-text pb-3" id="itemContent">헤비한 중량으로 따듯하게 착용 가능합니다 나일론을 유연제 처리하여 부드러운 착용감이 특징입니다.</p>
