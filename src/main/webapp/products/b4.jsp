			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title">스티치 세미오버핏 자켓 (챠콜)</h5>
							<h5 class="card-title pt-3 pb-3 border-top" id="price">74,400원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">SHIRTS</span>
							</p>
							<p class="card-text pb-3">세미 오버핏 자켓으로 클래식한 블레이져로 환절길에 가장 손이 가는 아이템입니다.</p>
