				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">스티치 세미오버핏 자켓</h5>
							
							<!-- 제품 가격 -->
							<hr/>
							PRICE
							<h5 class="card-title pt-3 pb-3 border-top" id="itemPrice">74400</h5>
							...
							<p class="card-text pb-3" id="itemContent">세미 오버핏 자켓으로 클래식한 블레이져로 환절길에 가장 손이 가는 아이템입니다.</p>
