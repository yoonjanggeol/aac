			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title">리미 체크머플러</h5>
							<h5 class="card-title pt-3 pb-3 border-top" id="price">19,800원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">ACCESSORIES</span>
							</p>
							<p class="card-text pb-3">발랄한 컬러감으로 겨울 코디의 포인트가 되어 줄 머플러 입니다. 부드러운 촉감으로 피부가 예민한 분들에게도 부담스럽지 않습니다.</p>
