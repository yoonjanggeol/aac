				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">링키 투웨이백</h5>
							...
							<p class="card-text border-top pt-3">
								...
								<span class="badge bg-dark">BACKPACK</span>
							</p>
							
							<p class="card-text pb-3" id="itemContent">메모리원단으로 제작되었으며 방풍 및 보온성이 뛰어납니다. 또한 생활 방수에 강합니다.</p>
