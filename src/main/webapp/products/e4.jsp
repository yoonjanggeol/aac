			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title">링키 투웨이백</h5>
							<h5 class="card-title pt-3 pb-3 border-top" id="price">37,900원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">ACCESSORIES</span>
							</p>
							<p class="card-text pb-3">메모리원단으로 제작되었으며 방풍 및 보온성이 뛰어납니다. 또한 생활 방수에 강합니다.</p>
