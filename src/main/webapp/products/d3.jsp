				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">뮬 스니커즈</h5>
							
							<!-- 제품 가격 -->
							<hr/>
							PRICE
							<h5 class="card-title pt-3 pb-3 border-top" id="itemPrice">12900</h5>
							...
							<p class="card-text pb-3" id="itemContent">키높이 별로 선택가능한 남녀공용 캔버스 스니커즈 디자인의 뮬 블로퍼 입니다.</p>
