			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title">뮬 스니커즈</h5>
							<h5 class="card-title pt-3 pb-3 border-top" id="price">12,900원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">SHOES</span>
							</p>
							<p class="card-text pb-3">키높이 별로 선택가능한 남녀공용 캔버스 스니커즈 디자인의 뮬 블로퍼 입니다.</p>
