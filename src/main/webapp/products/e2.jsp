			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title">플러피 파일럿 모자</h5>
							<h5 class="card-title pt-3 pb-3 border-top" id="price">32,200원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">ACCESSORIES</span>
							</p>
							<p class="card-text pb-3">부드러운 기모 원단으로 겨울에 머리를 감싸고 가벼우며 따듯하게 착용할 수 있습니다. 귀여운 무드를 연출할 수 있습니다.</p>
