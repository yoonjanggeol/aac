				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">플러피 파일럿 모자</h5>
							...
							<p class="card-text border-top pt-3">
								...
								<span class="badge bg-dark">HAT</span>
							</p>
							...
							<p class="card-text pb-3" id="itemContent">부드러운 기모 원단으로 겨울에 머리를 감싸고 가벼우며 따듯하게 착용할 수 있습니다. 귀여운 무드를 연출할 수 있습니다.</p>
