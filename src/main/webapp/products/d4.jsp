				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">LOVE 레터링 스니커즈</h5>
							
							<!-- 제품 가격 -->
							<hr/>
							PRICE
							<h5 class="card-title pt-3 pb-3 border-top" id="itemPrice">24900</h5>
							
							<!-- 제품 종류 -->
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark" id="itemType">신발</span>
							...
							<p class="card-text pb-3" id="itemContent">유니크한 디테일이 매력적인 스니커즈입니다. LOVE 레터링으로 포인트가 있습니다.</p>
