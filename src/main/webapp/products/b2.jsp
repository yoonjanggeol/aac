				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">퍼스텝 니트</h5>
							
							<!-- 제품 가격 -->
							<hr/>
							PRICE
							<h5 class="card-title pt-3 pb-3 border-top" id="itemPrice">46400</h5>
							...
							<p class="card-text pb-3" id="itemContent">컬러에 들어간 디테일이 눈에 띄는 감성적인 니트입니다. 전체적으로 여유로운 느낌을 줄수 있습니다.</p>
