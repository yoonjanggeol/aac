				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">포레스트 스니커즈</h5>
							
							<!-- 제품 가격 -->
							<hr/>
							PRICE
							<h5 class="card-title pt-3 pb-3 border-top" id="itemPrice">12000</h5>
							...
							<p class="card-text pb-3" id="itemContent">어디에서도 강한 접지력을 보여주는 캐쥬얼한 야외용 스니커즈입니다.</p>
