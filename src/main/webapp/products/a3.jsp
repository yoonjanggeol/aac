					...
					<div id="carouselExampleIndicators"
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img id="itemImg" src="../images/a3.jpg" class="d-block w-100" alt="...">
							</div>
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">울 트렌치 코트</h5>
							...
							<p class="card-text pb-3" id="itemContent">하프 기장감으로 체형커버에 탁월하여 인포켓으로 디자인되어
								고급스러움을 느낄 수 있습니다.</p>
