				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<h5 class="card-title pt-3 pb-3 border-top" id="price">219,000원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">NEW</span> <span
									class="badge bg-dark">HOT</span> <span class="badge bg-dark">ON SALE</span>
							</p>
