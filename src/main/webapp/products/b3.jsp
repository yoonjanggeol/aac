				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">투 톤 트렌치코트</h5>
							
							<!-- 제품 가격 -->
							<hr/>
							PRICE
							<h5 class="card-title pt-3 pb-3 border-top" id="itemPrice">142400</h5>
							
							<!-- 제품 종류 -->
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark" id="itemType">아우터</span>
								<span class="badge bg-dark">COAT</span>
							</p>
							
							<p class="card-text pb-3" id="itemContent">부담스럽지 않은 은은한 톤온톤 배색이 특징이며 고급스러운 무드를 표현할 수 있습니다.</p>
