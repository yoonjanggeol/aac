				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">허니 더비 슈즈</h5>
							
							<!-- 제품 가격 -->
							<hr/>
							PRICE
							<h5 class="card-title pt-3 pb-3 border-top" id="itemPrice">35000</h5>
							...
							<p class="card-text pb-3" id="itemContent">은은한 광택과 편안한 쿠션감을 주기 위한 밑창을 가볍게 제작한 로퍼입니다.</p>
