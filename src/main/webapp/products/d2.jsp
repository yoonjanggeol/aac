			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title">허니 더비 슈즈</h5>
							<h5 class="card-title pt-3 pb-3 border-top" id="price">35,000원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">SHOES</span>
							</p>
							<p class="card-text pb-3">은은한 광택과 편안한 쿠션감을 주기 위한 밑창을 가볍게 제작한 로퍼입니다.</p>
