				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<!-- 제품 이름 -->
							<h5 class="card-title" id="itemName">이태리 메탈 안경</h5>
							...
							<p class="card-text border-top pt-3">
								...
								<span class="badge bg-dark">GLASSES</span>
							</p>
							...
							<p class="card-text pb-3" id="itemContent">센스있는 패션을 완성하기 위하여 꼭 하나씩은 가지고 있는 동글뱅이 안경입니다.</p>
