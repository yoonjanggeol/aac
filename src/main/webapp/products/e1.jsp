			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title">이태리 메탈 안경</h5>
							<h5 class="card-title pt-3 pb-3 border-top" id="price">12,000원</h5>
							<p class="card-text border-top pt-3">
								<span class="badge bg-dark">ACCESSORIES</span>
							</p>
							<p class="card-text pb-3">센스있는 패션을 완성하기 위하여 꼭 하나씩은 가지고 있는 동글뱅이 안경입니다.</p>
