		...
		<div class="container text-center">
			...
			<nav>
				...
				<ul>
					...
					<li class="active"><a href="contact.jsp">About</a></li>
					<%
	...
	<div class="container-fluid pt70 pb70">
		<div id="fh5co-projects-feed"
			...
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/a1.jpg" alt="겜빗 스타디움 자켓"
					width="300px">
					<h2>겜빗 스타디움 자켓</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/a2.jpg" alt="톰 후드 자켓"
					width="300px">
					<h2>톰 후드 자켓</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/a3.jpg" alt="울 트렌치 코트"
					width="300px">
					<h2>울 트렌치 코트</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/a4.jpg" alt="오버핏 무스탕 자켓"
					width="300px">
					<h2>오버핏 무스탕 자켓</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/b1.jpg" alt="헤비 오버핏 니트"
					width="300px">
					<h2>헤비 오버핏 니트</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/b2.jpg" alt="퍼스텝 니트"
					width="300px">
					<h2>퍼스텝 니트</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/b3.jpg" alt="퍼스텝 니트"
					width="300px">
					<h2>퍼스텝 니트</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/b4.jpg"
					alt="스티치 세미오버핏 자켓 (챠콜)" width="300px">
					<h2>스티치 세미오버핏 자켓 (챠콜)</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/c1.jpg" alt="밴딩 쿨 크롭팬츠"
					width="300px">
					<h2>밴딩 쿨 크롭팬츠</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/c2.jpg" alt="히든 밴딩 슬랙스"
					width="300px">
					<h2>히든 밴딩 슬랙스</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/c3.jpg" alt="테이퍼드 슬랙스"
					width="300px">
					<h2>테이퍼드 슬랙스</h2>
				</a>
			</div>
			<div class="fh5co-project masonry-brick">
				<a href="single.html"> <img src="images/c4.jpg"
